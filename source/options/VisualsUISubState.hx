...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		rpcTitle = Language.getPhrase('discordrpc_settings_visual', "Visual Settings Menu"); //for Discord Rich Presence
		...
		if(noteSkins.length > 0)
		{
			...
			var option:Option = new Option('Note Skins:', 'Select your prefered Note Splash variation', 'noteSkin', STRING, noteSkins);
			addOption(option);
		...
		var option:Option = new Option('Note Splashes Opacity', 'How much transparent should the Note Splashes be.', 'splashAlpha', PERCENT);
