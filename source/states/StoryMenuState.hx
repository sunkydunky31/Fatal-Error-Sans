...
class StoryMenuState extends MusicBeatState
{
	...
	override function create() {
		...
		DiscordClient.changePresence(Language.getPhrase('discordrpc_menu_story-mode', "In the Menus"), null);
		#end
		...
		txtWeekTitle = new FlxText(FlxG.width * 0.7, 10, 0, "txtWeekTitle", 32);
