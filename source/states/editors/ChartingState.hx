	...
	**/
	...
	override function create() {
		if (PlayState.SONG != null)
			...
			// I really don't know who is the charter of FNF Vanilla
			// @Sunkydev31
			_song = {
				song: 'Test',
	...
	function addSongUI():Void {
		...
		#if MODS_ALLOWED
		var directories:Array<String> = [Paths.mods('characters/'), Paths.mods(Mods.currentModDirectory + '/characters/'), 'assets/shared/characters/'];
		for(mod in Mods.getGlobalMods())
			directories.push(Paths.mods(mod + '/characters/'));
		#else
		var directories:Array<String> = ['assets/shared/characters/'];
		#end
		...
		#if MODS_ALLOWED
		var directories:Array<String> = [Paths.mods('stages/'), Paths.mods(Mods.currentModDirectory + '/stages/'), 'assets/shared/stages/'];
		for(mod in Mods.getGlobalMods())
			directories.push(Paths.mods(mod + '/stages/'));
		#else
		var directories:Array<String> = ['assets/shared/stages/'];
		#end
		...
		charterInputText = new FlxUIInputText(10, 280, 150, _song.charter, 8);
		blockPressWhileTypingOn.push(charterInputText);

		artistInputText = new FlxUIInputText(charterInputText.x, charterInputText.y + 35, 150, _song.artist, 8);
		...
		tab_group_song.add(new FlxText(charterInputText.x, charterInputText.y - 15, 0, 'Charter(s):'));
		tab_group_song.add(new FlxText(artistInputText.x, artistInputText.y - 15, 0, 'Artist(s):'));
	...
	function loadCharacterFile(char:String):CharacterFile {
		...
		#end {
			path = 'assets/shared/characters/' + Character.DEFAULT_CHARACTER + '.json'; //If a character couldn't be found, change him to BF just to prevent a crash
	...
	private function saveLevel() {
		...
		var data:String = PsychJsonPrinter.print(json, ['sectionNotes', 'events']);
	...
	private function saveEvents() {
		...
		var data:String = PsychJsonPrinter.print(json, ['events']);
